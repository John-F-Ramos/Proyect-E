...
(function() {
    ...
    // Restricciones de rutas para estudiantes
    if (isStudent && (currentPath.includes('/plan-estudio') || currentPath.includes('/reportes'))) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        if (isStudent) {
            const navElements = document.querySelectorAll('a[href="/plan-estudio"], a[href="/reportes"]');
